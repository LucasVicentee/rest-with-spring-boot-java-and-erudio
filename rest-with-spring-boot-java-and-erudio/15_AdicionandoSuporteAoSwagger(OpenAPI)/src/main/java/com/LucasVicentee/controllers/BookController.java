...
import com.LucasVicentee.controllers.docs.BookControllerDocs;
import com.LucasVicentee.data.dto.BookDTO;
import com.LucasVicentee.services.BookServices;
...
public class BookController implements BookControllerDocs {
    ...
    // private BookServices service = new BookServices(); o @AutoWired substitui a chamada antiga por uma nova, funcionando como a injeção de dependências
    ...
    @Override
    public BookDTO create(@RequestBody BookDTO book) { // @RequestBody recupera os dados de um corpo para não retornar tudo nulo quando for adicionado algum dado
    ...
    @Override
    public BookDTO update(@RequestBody BookDTO book) { // @RequestBody recupera os dados de um corpo para não retornar tudo nulo quando for adicionado algum dado
